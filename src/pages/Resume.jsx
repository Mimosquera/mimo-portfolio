    ...
    <section className="section resume-section">
      ...
      <div className="resume-grid">
        <div className="resume-card">
          <p className="resume-card-label">Skills</p>
        ...
        <div className="resume-card">
          <p className="resume-card-label">Education</p>
      ...
      <div className="resume-card resume-card-full">
        <p className="resume-card-label">Experience</p>
        <div className="resume-entry">
          <div className="entry-header">
      ...
      <div className="resume-card resume-card-full">
        <p className="resume-card-label">Projects</p>
        <div className="resume-entry">
          <div className="entry-header">
